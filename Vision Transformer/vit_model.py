...
# 2D Image to Patch Embedding ( Linear Projection of Flattened Patches )
...
class VisionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_channel=3, num_classes=4,
        ...
        """
            ...
            qk_scale : change default qk scale value of head_dim^(-0.5) if set
            representation_size (Optional): enable and set representation layer (pre-logits) to this value if set
